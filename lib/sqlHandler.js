...
SqlStore.prototype._buildModels = function () {
  ...
  switch (self.config.dialect) {
    case 'postgres':
      modelAttributes = new modelGenerators.Postgres(self.resourceConfig.resource, localAttributes, self.resourceConfig.generateId)
      break
    default:
      modelAttributes = new modelGenerators.Default(self.resourceConfig.resource, localAttributes, self.resourceConfig.generateId)
      break
  }
